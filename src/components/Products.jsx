...
const Products = ({ addToCard }) => {
    ...
    return (
        <React.Fragment>
            <div className='flex flex-wrap mx-auto my-50 justify-center container gap-[30px] my-10'>
                {data.map((product) => (
                    <div key={product.id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-[#303C30] dark:border-gray-700">
                        ...
                        <div className="p-5">
                            <a href="#">
                                <h6 className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">{product.title}</h6>
                            </a>
